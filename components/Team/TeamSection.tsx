...
export default function TeamSection({
  ...
  return (
    <main className="hidden lg:flex lg:flex-col min-h-screen w-full max-w-none bg-black text-white relative overflow-hidden select-none px-0 mx-0">
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-none px-0 pt-4 pb-0">
        {/* Title */}
        <motion.div
        ...
        <div className="relative w-full h-[480px] md:h-[540px] lg:h-[600px] xl:h-[660px]">
          ...
          <div className="relative z-10 flex h-full w-full gap-[10px] lg:gap-[14px] px-0">
            {members.map((member, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 flex items-end justify-between h-full px-2 lg:px-4 pb-[8%]">
                    {isSilhouetteLeft ? (
                      <>
...
function NameBlock({ member }: { member: TeamMember }) {
  return (
    <div className="flex flex-col justify-end items-start text-left w-[44%] space-y-1">
